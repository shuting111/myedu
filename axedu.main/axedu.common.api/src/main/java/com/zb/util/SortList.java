...
//
//        // 按id倒序
//        SortList.sort(list, "id", SortList.DESC);
...
//
//        // 先按name正序排序,再按id正序排序
//        SortList.sort(list, new String[] { "name", "id" }, new String[] {});
//        System.out
...
//
//        // sortByMethod
//        SortList.sortByMethod(list, "getId", null);
